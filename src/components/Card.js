        ...
        <section className="about--me" id='aboutme'>
            ...
            <div className='about-me-third-row'>
                    <div className='about-me-details'>
                        ...
                        <label><span className='boldy'>Phone:</span> (+353) 83 390 2257</label>  
                        <div className="link-buttons">
                        <a href='https://github.com/nil1143'><i className="fa-brands fa-github about-me-links"></i></a>
                        <a href='https://www.linkedin.com/in/t-nil-b5b88a239/'><i className="fa-brands fa-linkedin-in about-me-links"></i></a>
                        <a href='https://twitter.com/home'><i class="fa-brands fa-twitter about-me-links"></i></a>
                        </div> 
                    </div>    
            </div>      
