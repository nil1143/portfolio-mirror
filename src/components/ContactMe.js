    ...
    return(
        <section className='contact-me' id='contact-me'>
            <div className='left-side-section'>
                ...
                <div className='icons'>
                    <a href='https://github.com/nil1143'><i className="fa-brands fa-square-github contact-me-links"></i></a>      
                    <a href='https://www.linkedin.com/in/t-nil-b5b88a239/'><i className="fa-brands fa-linkedin contact-me-links"></i></a>
                    <a href='https://twitter.com/home'><i className="fa-brands fa-square-twitter contact-me-links"></i></a>
